                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-5">
                                ...
                                <p class="mb-0 text-muted small">
                                    <?= htmlspecialchars($item['goodQuantity']) ?> × <?= htmlspecialchars(number_format($item['price'], 2)) ?> грн
                                </p>
                            </div>
                            <div class="col-3 text-end">
                                <!-- Placeholder for quantity controls if needed in the future -->
                            </div>
    ...
    <?php if (!empty($items)): ?>
        <div class="p-4 border-top bg-light">
            <div class="d-flex justify-content-end align-items-center mb-3">
                ...
                <h3 class="mb-0"><strong><?= htmlspecialchars(number_format($grandTotal, 2)) ?> грн</strong></h3>
            </div>
